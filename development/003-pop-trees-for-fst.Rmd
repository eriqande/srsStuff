...
list of the daughers of each internal node so that we can efficiently count up
...
# hey! Note that for computing the Fst values, we are going to want to have a daugher-centric
