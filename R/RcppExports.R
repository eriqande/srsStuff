...
#'
#' @export
pairwise_fst_from_dumpfile <- function(file, num_shorts, L, num_pops) {
    .Call(`_srsStuff_pairwise_fst_from_dumpfile`, file, num_shorts, L, num_pops)
}
...
#'
#' @export
srs_identity <- function(file, pops_of_indivs, num_pops, num_internal_nodes, daughters, BootReps, dump_pop_Ys, popYdump_file) {
    .Call(`_srsStuff_srs_identity`, file, pops_of_indivs, num_pops, num_internal_nodes, daughters, BootReps, dump_pop_Ys, popYdump_file)
}
...
#' blab
#' @export
test_call_by_reference <- function(x) {
    .Call(`_srsStuff_test_call_by_reference`, x)
}
